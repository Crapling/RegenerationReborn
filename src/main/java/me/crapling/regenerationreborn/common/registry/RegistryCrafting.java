...
public static void register(){
    ...
    GameRegistry.addShapelessRecipe(new ItemStack(RegistryItem.healthyBottle), new Object[]{RegistryItem.mysterium, RegistryItem.mysterium,RegistryItem.fernSpeciesX, Items.glass_bottle});
